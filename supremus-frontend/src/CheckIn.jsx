...
export default function CheckIn() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white shadow-xl rounded-3xl overflow-hidden border border-gray-200 print:shadow-none print:border-none print:m-0">
      ...
      {/* Cabeçalho simplificado para o novo contexto */}
      <div className="bg-gray-50 p-6 border-b border-gray-100 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-black text-blue-700 uppercase tracking-tight">Entrada de Equipamento</h2>
        ...
        <div className="text-right">
          ...
          <span className="text-xl font-black text-blue-800">#{obterOSBase()}</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSalvar} className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="flex items-center gap-2 text-blue-600 font-bold uppercase text-[10px] tracking-widest">
        ...
        {/* Relato */}
        <div className="space-y-3 border-t pt-4">
          <h3 className="text-blue-600 font-bold uppercase text-[10px] tracking-widest">Relato do Problema</h3>
        ...
        {osGerada && (
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-2xl text-center">
            <p className="text-blue-700 font-bold text-sm">OS GERADA COM SUCESSO!</p>
            <p className="text-2xl font-black text-blue-900">#{osGerada}</p>
          </div>
        )}
      </form>
    </div>
